import {  RETAIL_SHOP_TOP_REVENUE_PRODUCTS, RSTopRevenueProductsData, RSTopRevenueProductsVars } from '@/graphql/retail-shops/queries';
import { useQuery } from '@apollo/client';
import { Card, CardHeader, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Stack, Typography } from '@mui/material';
...
const RetailShopTopRevenueProducts = ({retailShopId}: Props) => {
    const {data,loading,error} = useQuery<RSTopRevenueProductsData,RSTopRevenueProductsVars>(RETAIL_SHOP_TOP_REVENUE_PRODUCTS,{
        variables:{
