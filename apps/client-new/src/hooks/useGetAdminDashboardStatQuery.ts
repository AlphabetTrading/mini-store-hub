import {
  GET_ADMIN_DASHBOARD_RETAIL_SHOPS_INSIGHTS_STATS,
  GET_ADMIN_DASHBOARD_STAT_BY_DATE,
...
export const useGetAdminDashboardInsightsStatQuery = (
  selectedFilter: any,
  retailShopId: string
) => {
  const targetDate = new Date();
  ...
  return useQuery(GET_ADMIN_DASHBOARD_RETAIL_SHOPS_INSIGHTS_STATS, {
    variables: {
