...
CREATE TABLE "User" (
    ...
    "amharicFirstName" TEXT,
    "amharicLastName" TEXT,
...
-- AddForeignKey
ALTER TABLE "UserProfile" ADD CONSTRAINT "UserProfile_addressId_fkey" FOREIGN KEY ("addressId") REFERENCES "Address"("id") ON DELETE CASCADE ON UPDATE CASCADE;
